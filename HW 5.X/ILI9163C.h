...
void LCD_drawChar(unsigned short xStart, unsigned short yStart, char symbol); // Draw a char on the LCD
void LCD_drawString(unsigned short left, unsigned short top, char *text); // Draw a string on the LCD
